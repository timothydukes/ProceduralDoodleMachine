...
- **PdmNano (main sketch, Nano tab)** — original code on `javax.sound.midi`
  (JDK); Phase 1 decision was to write this fresh rather than vendor a
  MIDI library. CC assignments follow the **Korg nanoKONTROL2 Parameter
  Guide** (Korg Inc.) factory default scene.
